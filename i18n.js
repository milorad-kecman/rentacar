...
const translations = {
  ...
  en: {
    ...
    why_f1_p:    'Over 10 vehicles, from economical city cars to premium vehicles for every need.',
  ...
  sr: {
    ...
    why_f1_p:    'Više od 10 vozila, od ekonomičnih gradskih automobila do premium vozila za svaku potrebu.',
